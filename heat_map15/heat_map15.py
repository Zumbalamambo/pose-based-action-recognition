...
class Spatial_CNN():
    ...
    def build_model(self):
        ...
        #build model
        self.model = resnet34(pretrained= True).cuda()
        #print self.model
...
class Data_Loader():
    ...
    def train(self):
        training_set = JHMDB_Pose_heatmap_data_set(dic=self.dic_training, root_dir=self.data_path, transform = transforms.Compose([
    ...
    def validate(self):
        validation_set = JHMDB_Pose_heatmap_data_set(dic=self.dic_testing, root_dir=self.data_path ,transform = transforms.Compose([
