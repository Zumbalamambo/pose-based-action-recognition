...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nb_classes=12, channel=10):
        self.inplanes = 64
...
def resnet18(pretrained=False, channel= 10, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], nb_classes=12, channel=channel, **kwargs)
    if pretrained:
...
def resnet34(pretrained=False, channel= 10, **kwargs):

    model = ResNet(BasicBlock, [3, 4, 6, 3], nb_classes=12, channel=channel, **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, channel= 10, **kwargs):

    model = ResNet(Bottleneck, [3, 4, 6, 3], nb_classes=12, channel=channel, **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, channel= 10, **kwargs):

    model = ResNet(Bottleneck, [3, 4, 23, 3],nb_classes=12, channel=channel, **kwargs)
    if pretrained:
